...
export default function EditBasic({setTitle,setDescription,setTags,setImageLink,setGitHubLink,setDemoLink,toggle,title,description,tags,imageLink,githubLink,demoLink,tagString,setTagString}:basicPropType) {
