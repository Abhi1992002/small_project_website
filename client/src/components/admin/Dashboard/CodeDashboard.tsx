...
export default function CodeDashboard({toggle, setCode }: codeType) {
  ...
  return (
    <div className="code-dashboard-wrapper">
      <div className="choose-language-wrapper">
        ...
        <div>
          <input type="checkbox" id="HTML" name="HTML" value="HTML" onChange={()=>{setHtml(!html)}}/>
          <label style={{marginLeft:'10px'}} className="subheading" htmlFor="HTML">HTML</label>
        </div>

        <div>
          <input type="checkbox" id="CSS" name="CSS" value="CSS" onChange={()=>{setCss(!css)}}/>
          <label style={{marginLeft:'10px'}} className="subheading" htmlFor="CSS">CSS</label>
        </div>

        <div>
          <input onChange={()=>{setJs(!js)}} type="checkbox" id="JS" name="JS" value="JS" />
          <label style={{marginLeft:'10px'}} className="subheading" htmlFor="JS">JS</label>
        </div>

        <div>
          <input onChange={()=>{setTs(!ts)}} type="checkbox" id="TS" name="TS" value="TS" />
          <label style={{marginLeft:'10px'}} className="subheading" htmlFor="TS">TS</label>
        </div>

        <div>
          <input onChange={()=>{setReact(!react)}} type="checkbox" id="React" name="React" value="React" />
